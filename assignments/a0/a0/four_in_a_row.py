...
class FourInARow:
    ...
    Attributes:
    n: the size of the game board, n-n grid
    p1_human: whether p1 is human or computer
    p2_human: whether p2 is human or computer
    board: instance of class grid, board
    result: the current state of the game,WIN , DRAW, LOSS, IN_PROGRESS
    p1_to_play: if it is p1's turn to play
