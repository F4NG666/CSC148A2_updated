...
class PerimeterGoal(Goal):
    ...
    def description(self) -> str:
        ...
        """
        # TODO: Implement this method
        colour_name = colour_name(self.colour)
        return f"Goal: Maximize the number of {colour_name} blocks on the perimeter."
...
class BlobGoal(Goal):
    ...
    def description(self) -> str:
        ...
        # TODO: Implement this method
        colour_name = colour_name(self.colour)
        return f"Goal: Create the largest connected blob of {colour_name} blocks."
