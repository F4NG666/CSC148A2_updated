...
#       - One of these should call the Employee.total_pay() method
#       - One of these should call the Company.total_payroll() method

def test_SalariedEmployee_total_pay() -> None:
...
def test_Company_total_payroll() -> None:
