...
def test_max_length_one_int() -> None:
    """test max_length with only one integer"""
    assert max_length(1) == 0


def test_max_length_empty() -> None:
    """test max_length with empty input"""
    assert max_length([]) == 0


def test_max_length_only_int() -> None:
    """"test max_length with only one int"""
    assert max_length([1, 2, 3, 4, 45]) == 5
