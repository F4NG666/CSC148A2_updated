...
if __name__ == '__main__':
    ...
    # right-click in the file and select "Run prep4" or "Run File in Python Con
    # sole".
    #
    # python_ta will check your work and open up your web browser to display
    # its report. For full marks, you must fix all issues reported, so that
    # you see "None!" under both "Code Errors" and "Style and Convention Err
    # ors".
    # TIP: To quickly uncomment lines in PyCharm, select the lines below and
    # press
    # "Ctrl + /" or "⌘ + /".
    import python_ta
